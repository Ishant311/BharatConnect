...
import { Home, PlusSquare, Search, User2 } from 'lucide-react'
...
function Footer() {
  ...
  return (
    <>
      ...
      <div className='sm:hidden fixed w-full h-20 flex items-center justify-center bottom-0 left-0 right-0 bg-white shadow-md'>
